						...
						<thead>
							<tr>
								...
								<th
									...
									<span v-show="direction == 'in'">Total / </span> Date</th>
								<th
									...
									<table class="table-auto min-w-full text-xs divide-y divide-gray-300">
										<tbody class="bg-transparent border divide-y divide-gray-300">
											<tr>
												...
												<th class="px-2 py-1 border border-gray-300">Qty <span
														v-show="direction == 'in'">* Rate = Total</span></th>
											</tr>
											<tr v-for="(item, key) in item_inventory.group_items" :key="item.id">
												...
												item.required_quantity_unit }} <span v-show="direction == 'in'">{{
													item.required_rate_total }}</span></td>
										</tr>
									</tbody>
								</table>
							</td>
