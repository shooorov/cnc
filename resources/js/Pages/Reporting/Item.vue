...
const submit = () => {
	router.visit(route('summary.item'), {
		data: form,
	});
}
			...
			<div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
				<div class="bg-white shadow sm:rounded-lg">
					<div
						...
						<div class="flex-1">
							<h3 class="text-base font-semibold leading-6 text-gray-900">Item Summary</h3>
						...
						<div class="flex-shrink-0 flex space-x-3">
							<a :href="route('export.sale_items', form)" type="button"
								v-if="navigation.routes.includes('export.sale_items')"
					...
					<table class="table-auto sm:table-fixed min-w-full w-full" id="table">
						...
						<tbody class="bg-white">
							<tr v-for="(item, index) in items" :key="item.id"
								:class="[Number(index) % 2 == 0 ? 'bg-white' : 'bg-gray-50', 'border-b']">
